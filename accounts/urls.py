...
from accounts.views import RegisterView, email_verification, PasswordResetRequestView, AccountPasswordResetConfirmView, \
    UserListView, UserBlockView, UserDetailView, UserEditView
...
urlpatterns = [
    ...
    path("password-reset-confirm/<str:token>/", AccountPasswordResetConfirmView.as_view(),
         name="password-reset-confirm"),
    path("accounts/", UserListView.as_view(), name="user_list"),
    path("accounts/<int:pk>/", UserDetailView.as_view(), name="user_detail"),
    path("accounts/<int:pk>/block/", UserBlockView.as_view(), name="user_block"),
    path("accounts/<int:pk>/edit/", UserEditView.as_view(), name="user_edit"),
]
